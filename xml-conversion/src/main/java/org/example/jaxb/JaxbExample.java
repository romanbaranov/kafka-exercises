...
import org.example.jaxb.model.Company;
import org.example.jaxb.model.Staff;
...
//                    .createContext(new Class[] {Company.class}, null);
            ...
            jaxbMarshaller.marshal(createCompanyObject(), new File("xml-conversion/dir/company.xml"));
